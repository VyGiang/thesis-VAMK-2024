...
export const fams: IFamilyMember[] = [
  new FamilyMember({
    ...
    birthday: Timestamp.fromDate(new Date("1987-03-02T08:00:00Z")), // Assuming John's birthday is May 15, 1987
  }),
  new FamilyMember({
    name: "Minh",
    memberId: 2,
    ...
    birthday: Timestamp.fromDate(new Date("2001-28-01T08:00:00Z")), // Assuming Minh's birthday is April 2, 1998
  }),
]
// Dummy Rooms
